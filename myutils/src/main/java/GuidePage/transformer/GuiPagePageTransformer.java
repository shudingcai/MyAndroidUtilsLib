...
public abstract class GuiPagePageTransformer implements ViewPager.PageTransformer {
    ...
    public static GuiPagePageTransformer getPageTransformer(TransitionEffect effect) {
        switch (effect) {
            case Default:
