...
import GuidePage.transformer.GuiPagePageTransformer;
import GuidePage.transformer.TransitionEffect;
import kostal.com.myutils.R;

public class Banner extends RelativeLayout implements BannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private void initViewPager() {
        ...
        mViewPager.setOverScrollMode(mOverScrollMode);
        mViewPager.setAllowUserScrollable(mAllowUserScrollable);
        mViewPager.setPageTransformer(true, GuiPagePageTransformer.getPageTransformer(mTransitionEffect));
